...
const ArtistSignupPage: React.FC = () => {
  ...
  const { signUpAsArtist, signInWithGoogle } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Failed to create artist account. Please try again.');
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="border-t border-gray-700 pt-6">
              ...
              <div className="mt-4">
                ...
                <button
                  ...
                  disabled={loading}
                  className="mt-4 w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-3 px-6 rounded-lg transition-colors flex items-center justify-center"
                >
