...
import { authApi, artistApplicationApi, roleRequestsApi } from '../services/api';
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        {(artistApplication || roleRequests.length > 0) && (
          <section className="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
            ...
            {artistApplication && (
              <div className="flex items-center justify-between p-4 bg-gray-700/30 rounded-lg border border-gray-600 mb-3">
                <div>
            ...
            {roleRequests.map((req) => (
              <div key={req.id} className="flex items-center justify-between p-4 bg-gray-700/30 rounded-lg border border-gray-600 mb-3 last:mb-0">
                <div>
