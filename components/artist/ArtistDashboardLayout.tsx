...
const ArtistDashboardLayout: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#122118] text-white">
      {/* ── Sidebar ─────────────────────────────────────────── */}
      <aside className="fixed inset-y-0 left-0 w-64 bg-[#1a1a1a] border-r border-[#282828] flex flex-col z-30">
        {/* Logo */}
      ...
      <div className="flex-1 ml-64 flex flex-col min-h-screen overflow-hidden">
        {/* Header */}
        <header className="sticky top-0 z-20 h-16 bg-[#122118]/80 backdrop-blur-md border-b border-[#282828] flex items-center px-8">
