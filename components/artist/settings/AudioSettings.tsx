...
const STORAGE_KEY = 'artist_audio';
...
const AudioSettings: React.FC<AudioSettingsProps> = ({ onSave }) => {
  ...
  const items: { key: keyof AudioToggles; label: string; description: string }[] = [
    ...
    },
    {
      ...
      description: 'Allow explicit content on your releases',
    },
    {
      key: 'highQualityAudio',
      label: 'High Quality Audio',
      description: 'Stream and upload in high quality (when available)',
    },
    {
    ...
    <div className="bg-gray-900/50 border border-gray-700/50 rounded-xl overflow-hidden">
      <div className="p-6 border-b border-gray-700/50">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold text-white">Audio & Music</h2>
        </div>
        <p className="text-sm text-gray-400 mt-1">Configure audio playback and content preferences</p>
      </div>
