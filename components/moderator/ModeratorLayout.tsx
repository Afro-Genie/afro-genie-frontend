...
const ModeratorLayout: React.FC = () => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/moderator', icon: ShieldIcon },
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="fixed inset-y-0 left-0 w-64 bg-gray-800 shadow-lg z-30">
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-center h-16 px-4 bg-gray-900">
            <LogoIcon className="h-8 w-8 text-blue-400" />
            <span className="ml-2 text-xl font-bold text-white">Moderator Hub</span>
          </div>
          ...
          <div className="px-4 py-4 border-t border-gray-700">
            <div className="flex items-center mb-4">
              ...
              <div className="ml-3 flex-1 min-w-0">
                <p className="text-sm font-medium text-white truncate">{user?.displayName || 'Moderator'}</p>
