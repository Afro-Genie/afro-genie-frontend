...
const STORAGE_KEY = 'user_privacy';
...
const UserPrivacySettings: React.FC<UserPrivacySettingsProps> = ({ onSave }) => {
  ...
  const items: { key: keyof PrivacyToggles; label: string; description: string; icon: React.ReactNode }[] = [
    ...
    },
    {
      ...
      description: 'Let others see what you are listening to',
...
export type { PrivacyToggles, UserPrivacySettingsProps };
